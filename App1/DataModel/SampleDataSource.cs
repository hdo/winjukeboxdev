...
namespace App1.Data
{
    ...
    public class SampleDataItem
    {
        public SampleDataItem(String uniqueId, String title, String subtitle, String imagePath, String description, String content)
        {
            ...
            this.Dirname = "";
            this.Tracks = new ObservableCollection<String>();
        }
    ...
    public sealed class SampleDataSource
    {
        ...
        private async Task GetSampleDataAsync()
        {
            ...
            foreach (JsonValue groupValue in jsonArray)
            {
                ...
                System.Diagnostics.Debug.WriteLine("Processing " + groupObject["UniqueId"].GetString());


                foreach (JsonValue itemValue in groupObject["Items"].GetArray())
                {
                    JsonObject itemObject = itemValue.GetObject();
                    SampleDataItem dataItem = new SampleDataItem(itemObject["UniqueId"].GetString(),
                    ...
                    if (itemObject.ContainsKey("Dirname"))
                    {
                        dataItem.Dirname = itemObject["Dirname"].GetString();
                    }

                    // JsonArray jArray = itemObject[["Tracks"].GetArray();
                    // some elements don't have Tracks key
                    if (itemObject.ContainsKey("Tracks"))
                    {
                        foreach (JsonValue s in itemObject["Tracks"].GetArray())
                        {
                            dataItem.Tracks.Add(s.GetString());
                        }
                    }
